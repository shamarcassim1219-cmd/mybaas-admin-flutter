                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          children: [
                            Icon(Icons.receipt_long_outlined, color: AppColors.primary, size: 22),
                            SizedBox(width: 12),
                            Expanded(child: Text('All Orders', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),
                            Icon(Icons.chevron_right, size: 18, color: AppColors.textMuted),
                          ],
                        ),
                      ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          children: [
                            Icon(Icons.phonelink_erase_outlined, color: AppColors.primary, size: 22),
                            SizedBox(width: 12),
                            Expanded(child: Text('Banned Devices', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600))),
                            Icon(Icons.chevron_right, size: 18, color: AppColors.textMuted),
                          ],
                        ),
                      ),
