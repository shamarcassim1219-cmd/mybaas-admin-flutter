...
/// pay_now order automatically refunds the order total to the
/// customer's wallet - nothing extra to trigger here.
          ...
          children: [
            if (isApprove && c.wouldRefundOnApprove && c.orderTotal != null)
              Container(
                ...
                child: Text(
                  'This is a Pay Now order that was paid. Approving will refund Rs. ${c.orderTotal!.toStringAsFixed(2)} to ${c.customerName}\'s wallet automatically.',
